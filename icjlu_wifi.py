...
init_url="http://10.253.0.100"#http://172.16.8.6
get_challenge_api="http://10.253.0.100/cgi-bin/get_challenge"#http://172.16.8.6/cgi-bin/get_challenge

srun_portal_api="http://10.253.0.100/cgi-bin/srun_portal"# http://172.16.8.6/cgi-bin/srun_portal
get_info_api="http://10.253.0.100/cgi-bin/rad_user_info?callback=jQuery11240016121590916347683_1646271806321&_=1646271806322"  #http://172.16.8.6/cgi-bin/rad_user_info?callback=jQuery112406118340540763985_1556004912581&_=1556004912582
n = '200'
type = '1'
ac_id='3'
enc = "srun_bx1"
...
if __name__ == '__main__':
	...
	username="你的学号"   #输入你的学号例如"S20071-----"
	password="你的密码"  #你的密码，都要加引号，例如"123456"
	init_getip()
	get_token()
	do_complex_work()
	login()
